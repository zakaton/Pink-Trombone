...
class GlottisUI {
    ...
    drawKeyboard() {
        this.context.strokeStyle = this.context.fillStyle = GlottisUI.palePink;
        ...
        this.backContext.strokeStyle = this.backContext.fillStyle = "orchid";
    ...
    drawBar(topFactor, bottomFactor, radius) { 
        ...
        this.backContext.beginPath();
        this.backContext.moveTo(this.keyboard.left + radius, this.keyboard.top + topFactor * this.keyboard.height + radius);
        this.backContext.lineTo(this.keyboard.left + this.keyboard.width - radius, this.keyboard.top + topFactor * this.keyboard.height + radius);
        this.backContext.lineTo(this.keyboard.left + this.keyboard.width - radius, this.keyboard.top + bottomFactor * this.keyboard.height - radius);
        this.backContext.lineTo(this.keyboard.left + radius, this.keyboard.top + bottomFactor * this.keyboard.height - radius);
